...
% Centers the content in the given length
% Use as:
...
%\SetWatermarkText{Do not circulate}  %
...
\author[M. Arca Sedda \& P. Amaro-Seoane] % Running authors, % use abbrev. names here
{
Manuel Arca Sedda$^{1}$
...
\begin{keywords}
% Llista sencera: http://oxfordjournals.org/our_journals/mnrasl/for_authors/mnraskey.pdf
a keyword -- another.
\end{keywords}
